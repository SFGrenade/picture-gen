...
ffmpeg -hide_banner -y -hwaccel cuda -hwaccel_output_format cuda `
    -loop 1 -r $fps -i ..\bg.old.png -max_size "$bitrate / 8 / $fps" -r $fps -i audio.wav -loop 1 -r $fps -i ..\circle.png -loop 1 -r $fps -i art.png -shortest `
